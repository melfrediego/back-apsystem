        ...
        <div class="flex flex-col w-full max-w-md mx-auto">
            <div class="flex-1 flex flex-col justify-center">
                ...
                <div class="text-center md:text-left">
                    <h2 class="text-2xl font-bold text-slate-500 dark:text-white">Recupera senha!</h2>
                    <p class="mt-3 text-slate-500 dark:text-gray-300 text-sm">Utilize o formulario abaixo para <br>
                        recuperar sua senha.</p>
                    <p class="mt-8 text-gray-500 font-semibold">Redefinir</p>
                </div>
                <div class="mt-4">
                    <form action="">
                        @csrf
                        <div class="relative mb-8">
                            ...
                            <p class="text-xs px-1 mt-2 text-gray-400">Voce receberá um e-mail no endereço informado
                                    acima, com o procedimento para criar uma nova senha</p>
                        </div>
