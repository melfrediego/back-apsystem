    ...
    <form class="card shadow-sm" wire:submit="store">
        <div class="card-header">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bolder fs-4 mb-0">Criar categorias</span>
                <span class="text-muted mt-1 fw-normal fs-7">Utilize o formulário abaixo para criar uma nova categoria</span>
            </h3>
        ...
        <div class="card-body">
            ...
            <div class="mb-10 fv-row fv-plugins-icon-container">
                ...
                @if ($logo)
                    <div class="my-2">
                        <img src="{{ $logo->temporaryUrl() }}" alt="Logo Preview" class="rounded w-100px h-100px block">
                    </div>
                @endif
            </div>            
            <div class="mb-10 fv-row fv-plugins-icon-container">
