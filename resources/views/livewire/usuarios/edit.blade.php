            ...
            {{-- <div class="mb-10 fv-row fv-plugins-icon-container">
                <div class="row row-cols-1 row-cols-md-2 row-cols-lg-2 row-cols-xl-2 g-9 mb-2">
                    <div class="col">
                        ...
                        <input wire:model='senha' type="password" name="senha" class="form-control mb-2" disabled>
                    </div>
                    <div class="col">
                        <label class="form-label">Confirmar senha</label>
                        <input wire:model='confirma_senha' type="password" name="confirma_senha" class="form-control mb-2" disabled>
                    </div>
                </div>
