<div>
    ...
    {{-- <div class="d-flex flex-column flex-column-fluid"> --}}
        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6 ">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-fuild d-flex flex-stack ">
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    ...
                    <a href="/../demo1/apps/ecommerce/sales/listing.html"
                        class="btn btn-sm fw-bold btn-secondary">
                        Gerenciar vendas </a>
                    <!--end::Secondary button-->

                    <!--begin::Primary button-->
                    <a href="/../demo1/apps/ecommerce/catalog/add-product.html"
                        ...
                        <div class="card card-flush h-md-50 mb-5 mb-xl-10">
                            ...
                            <div class="card-header pt-5">
                                ...
                                <div class="card-title d-flex flex-column">
                                    ...
                                    <!--begin::Subtitle-->
                                    <span class="text-gray-400 pt-1 fw-semibold fs-6">Ganhos esperados</span>
                                    <!--end::Subtitle-->
                                </div>
                                <!--end::Title-->
                            </div>
                            ...
                            <div class="card-body pt-2 pb-4 d-flex align-items-center">
                                ...
                                <div class="d-flex flex-column content-justify-center w-100">
                                    ...
                                    <div class="d-flex fs-6 fw-semibold align-items-center">
                                        ...
                                        <!--begin::Label-->
                                        <div class="text-gray-500 flex-grow-1 me-4">Alisantes</div>
                                        <!--end::Label-->
                                    ...
                                    <div class="d-flex fs-6 fw-semibold align-items-center my-3">
                                        ...
                                        <!--begin::Label-->
                                        <div class="text-gray-500 flex-grow-1 me-4">Mascaras</div>
                                        <!--end::Label-->
                                    ...
                                    <div class="d-flex fs-6 fw-semibold align-items-center">
                                        ...
                                        <!--begin::Label-->
                                        <div class="text-gray-500 flex-grow-1 me-4">Outros</div>
                                        <!--end::Label-->
                        ...
                        <div class="card card-flush h-md-50 mb-xl-10">
                            ...
                            <div class="card-header pt-5">
                                ...
                                <div class="card-title d-flex flex-column">
                                    ...
                                    <!--begin::Subtitle-->
                                    <span class="text-gray-400 pt-1 fw-semibold fs-6">Pedidos este mês</span>
                                    <!--end::Subtitle-->
                                </div>
                                <!--end::Title-->
                            </div>
                        ...
                        <div class="card card-flush  h-md-50 mb-5 mb-xl-10">
                            ...
                            <div class="card-header pt-5">
                                ...
                                <div class="card-title d-flex flex-column">
                                    ...
                                    <!--begin::Subtitle-->
                                    <span class="text-gray-400 pt-1 fw-semibold fs-6">Vendas média diárias</span>
                                    <!--end::Subtitle-->
                                </div>
                                <!--end::Title-->
                            </div>
                        ...
                        <div class="card card-flush h-md-50 mb-xl-10">
                            ...
                            <div class="card-header pt-5">
                                ...
                                <div class="card-title d-flex flex-column">
                                    ...
                                    <!--begin::Subtitle-->
                                    <span class="text-gray-400 pt-1 fw-semibold fs-6">Novos clientes nesse mês</span>
                                    <!--end::Subtitle-->
                                </div>
                                <!--end::Title-->
                            </div>
                        ...
                        <div class="card card-flush overflow-hidden h-md-100">
                            ...
                            <div class="card-header py-5">
                                ...
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label fw-bold text-dark">Vendas no mês</span>
                                    <span class="text-gray-400 mt-1 fw-semibold fs-6">Total de todos os canais</span>
                                </h3>
                                <!--end::Title-->
                    ...
                    <div class="col-xl-6 mb-xl-10">
                        ...
                        <div class="card h-md-100">
                            ...
                            <div class="card-header align-items-center border-0">
                                <!--begin::Title-->
                                <h3 class="fw-bold text-gray-900 m-0">Pedidos recentes</h3>
                                <!--end::Title-->
                                            ...
                                            <table
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="ps-0">
                                                            <a href="/../demo1/apps/ecommerce/catalog/edit-product.html"
                    ...
                    <div class="col-xl-6 mb-5 mb-xl-10">
                        ...
                        <div class="card card-flush overflow-hidden h-md-100">
                            ...
                            <div class="card-header py-5">
                                <!--begin::Title-->
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label fw-bold text-dark">Vendas de produtos com desconto</span>
                                    <span class="text-gray-400 mt-1 fw-semibold fs-6">Vendas em todos os canais</span>
                                </h3>
                                <!--end::Title-->
                            ...
                            <div class="card-body d-flex flex-column flex-center">
                                ...
                                <div class="text-center mb-1">
                                    ...
                                    <a class="btn btn-sm btn-primary me-2"
                                        href="/../demo1/apps/ecommerce/sales/listing.html">
                                        View App </a>
                                    <!--end::Link-->

                                    <!--begin::Link-->
                                    <a class="btn btn-sm btn-light"
                                        href="/../demo1/apps/ecommerce/catalog/add-product.html">
                                        New Product </a>
                                    <!--end::Link-->
                                </div>
                                <!--end::Links-->
                    ...
                    <div class="col-xl-8 mb-5 mb-xl-10">
                        ...
                        <div class="card card-flush h-xl-100">
                            ...
                            <div class="card-header pt-7">
                                <!--begin::Title-->
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label fw-bold text-gray-800">Pedidos de produtos</span>
                                    <span class="text-gray-400 mt-1 fw-semibold fs-6">Media de QTD. por dia</span>
                                </h3>
                                <!--end::Title-->
                    ...
                    <div class="col-xl-4">
                        ...
                        <div class="card card-flush h-xl-100">
                            ...
                            <div class="card-header pt-7">
                                <!--begin::Title-->
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label fw-bold text-dark">Estreda de Produtos</span>
                                    <span class="text-gray-400 mt-1 fw-semibold fs-6">Qtd. de produtos enviados</span>
                                </h3>
                                <!--end::Title-->
                                ...
                                <div class="card-toolbar">
                                    <a href="/../demo1/apps/ecommerce/sales/details.html"
                                        class="btn btn-sm btn-light">Detalhes pedido</a>
                                </div>
                                <!--end::Toolbar-->
                            </div>
                            <!--end::Header-->
                    ...
                    <div class="col-xl-8">
                        ...
                        <div class="card card-flush h-xl-100">
                            ...
                            <div class="card-header pt-7">
                                <!--begin::Title-->
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label fw-bold text-dark">Relatorio de estoque</span>
                                ...
                                <div class="card-toolbar">
                                    ...
                                    <div class="d-flex flex-stack flex-wrap gap-4">
                                        ...
                                        <!--begin::Search-->
                                        <a href="/../demo1/apps/ecommerce/catalog/products.html"
                                ...
                                <table class="table align-middle table-row-dashed fs-6 gy-3"
                                    ...
                                    <thead>
                                        ...
                                        <tr
                                            ...
                                            <th class="text-end pe-3 min-w-100px">ID Produto</th>
                                            <th class="text-end pe-3 min-w-150px">Data Cadastro</th>
                                            <th class="text-end pe-3 min-w-100px">Preço</th>
                                            <th class="text-end pe-3 min-w-100px">Status</th>
                                            <th class="text-end pe-0 min-w-75px">Quantidade</th>
                                        </tr>
                                        <!--end::Table row-->
                                    </thead>
                                    <!--end::Table head-->
