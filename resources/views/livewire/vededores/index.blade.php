<div>
    <div class="card shadow-sm mb-5 mr-2 pb-8 mb-xl-4">
        ...
        <div class="card-header border-0 pt-0">
            ...
            <div class="card-toolbar">
                <a href="{{ route('vendedores.create') }}" class="btn btn-sm btn-primary">
                            ...
                            @foreach ($vendedores as $vendedor)
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="symbol symbol-50px me-5">
                                                @if ($vendedor->user->foto)
                                                    <img src="{{ asset('storage/' . $vendedor->user->foto) }}" alt="Foto vendedor" width="50">
                                                @else
                                                    Sem foto
                                                @endif
                                            </div>
                                    ...
                                    <td class="text-end min-w-150px">
                                        <a href="{{ route('vendedores.edit', ['id' => $vendedor->id]) }}" class="btn btn-icon btn-light-primary btn-color-primary btn-sm me-1">
                                            <i class="fa-solid fa-info"></i>
                                        </a>
                                        <a href="{{ route('vendedores.edit', ['id' => $vendedor->id]) }}" class="btn btn-icon btn-light-warning btn-color-warning btn-sm me-1">
    ...
    <div class="row">
        ...
        <div class="col-sm-12 col-md-8 d-flex align-items-center justify-content-center justify-content-md-end">
            {{ $vendedores->links('vendor.livewire.custom-pagination'); }}
        </div>
    </div>
</div>
