            ...
            <div class="col-sm-12 col-md-12 d-flex align-items-center justify-content-center justify-content-md-start">
                <div class="d-flex align-items-center">
                    ...
                    <div class="position-relative w-md-400px min-w-400px me-md-2">
                        ...
                        <!--end::Svg Icon-->
                        <input type="text" wire:model.live='search' class="form-control form-control-solid ps-12" name="search" value="" placeholder="Pesquisar por: numero ou nome cliente">
                    </div>
                    ...
                    <select class="form-select form-select-sm form-select-solid w-120px me-md-2">
                    ...
                    <thead>
                        <tr class="fw-bolder text-muted">
                            <th class="rounded-start">
                                <a href="#" class="text-gray-600">Coluna 1</a>    
                            </th>
                            <th class="rounded-start">
                            ...
                            @foreach ($pedidos as $produto)
                                <tr>
                                    ...
                                    <td class="text-end min-w-150px">
                                        <a href="{{ route('pedidos.edit', ['id' => 1]) }}" class="btn btn-icon btn-light-primary btn-color-primary btn-sm me-1">
                                            <i class="fa-solid fa-info"></i>
                                        </a>
                                        <a href="{{ route('produtos.edit', ['id' => 1]) }}" class="btn btn-icon btn-light-warning btn-color-warning btn-sm me-1">
