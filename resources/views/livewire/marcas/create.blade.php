    ...
    <form class="card shadow-sm" wire:submit="store">
        <div class="card-header">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bolder fs-4 mb-0">Criar marcas</span>
                <span class="text-muted mt-1 fw-normal fs-7">Utilize o formulário abaixo para criar uma nova marca</span>
            </h3>
